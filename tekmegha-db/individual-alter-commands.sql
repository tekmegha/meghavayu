-- ============================================
-- Individual ALTER Commands for megha_stores Table
-- Execute these commands one by one if needed
-- ============================================

-- 1. Add Business Information Columns
...
-- 2. Add Tax and Legal Information Columns
...
-- 3. Add Feature Management Columns
...
-- 4. Add Invoice-Specific Columns
...
-- 5. Add Status and Verification Columns
...
-- 7. Create Indexes (execute after adding columns)
